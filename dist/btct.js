...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = './dist/btct.data';
      var REMOTE_PACKAGE_BASE = 'btct.data';
...
Module['FS_createPath']('/img', 'bg_splashes', true, true);
Module['FS_createPath']('/img', 'bg_tiles', true, true);
Module['FS_createPath']('/img', 'characters', true, true);
Module['FS_createPath']('/img/characters', 'branded', true, true);
Module['FS_createPath']('/img/characters/branded', 'helmet', true, true);
Module['FS_createPath']('/img/characters', 'generic', true, true);
Module['FS_createPath']('/img', 'temp', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_./dist/btct.data');

      };
      Module['addRunDependency']('datafile_./dist/btct.data');
   ...
   loadPackage({"files": [{"filename": "/img/font_fixedsys10x20-Jank.png", "start": 0, "end": 9164, "audio": 0}, {"filename": "/img/font_fixedsys10x20-what.png", "start": 9164, "end": 18328, "audio": 0}, {"filename": "/img/font_fixedsys10x20.png", "start": 18328, "end": 47921, "audio": 0}, {"filename": "/img/font_fixedsys8x16.png", "start": 47921, "end": 51062, "audio": 0}, {"filename": "/img/font_fp.png", "start": 51062, "end": 52333, "audio": 0}, {"filename": "/img/GBStudioFontThick.png", "start": 52333, "end": 53851, "audio": 0}, {"filename": "/img/bg_splashes/10_years_too_early.bmp", "start": 53851, "end": 1090769, "audio": 0}, {"filename": "/img/bg_splashes/10_years_too_early.png", "start": 1090769, "end": 1112682, "audio": 0}, {"filename": "/img/bg_splashes/map.png", "start": 1112682, "end": 1124003, "audio": 0}, {"filename": "/img/bg_splashes/map_panels.png", "start": 1124003, "end": 1166958, "audio": 0}, {"filename": "/img/bg_splashes/map_panels_jank.png", "start": 1166958, "end": 1177153, "audio": 0}, {"filename": "/img/bg_splashes/map_panels_jank_2.png", "start": 1177153, "end": 1187612, "audio": 0}, {"filename": "/img/bg_splashes/map_panels_ok.png", "start": 1187612, "end": 1197984, "audio": 0}, {"filename": "/img/bg_splashes/vitals.png", "start": 1197984, "end": 1208555, "audio": 0}, {"filename": "/img/bg_tiles/us-floor-top.bmp", "start": 1208555, "end": 1209185, "audio": 0}, {"filename": "/img/characters/branded/helmet/CLizIdle.png", "start": 1209185, "end": 1209536, "audio": 0}, {"filename": "/img/characters/generic/Melly Hon Eydu.png", "start": 1209536, "end": 1244368, "audio": 0}, {"filename": "/img/temp/mock-map.bmp", "start": 1244368, "end": 1309286, "audio": 0}, {"filename": "/img/temp/mock-vitals-scaled-with-overlay.bmp", "start": 1309286, "end": 4808540, "audio": 0}, {"filename": "/img/temp/mock-vitals.bmp", "start": 4808540, "end": 5197394, "audio": 0}, {"filename": "/img/temp/mock-vitals.png", "start": 5197394, "end": 5207965, "audio": 0}, {"filename": "/img/temp/MockCidle-32x32.png", "start": 5207965, "end": 5208316, "audio": 0}, {"filename": "/img/temp/unset_sprite.png", "start": 5208316, "end": 5208667, "audio": 0}], "remote_package_size": 5208667, "package_uuid": "53a4671b-8dfe-4398-8a5f-6cb6ef98b3a2"});
...
var ASM_CONSTS = {
  60812: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 62291: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 63280: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 63373: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 64598: function() {return screen.width;},  
 64625: function() {return screen.height;},  
 64653: function() {return window.innerWidth;},  
 64685: function() {return window.innerHeight;},  
 64763: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 64897: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 65063: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 65289: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 65842: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 65912: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 67564: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 67974: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 68579: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
